...
root.innerHTML=
  ...
  '@media(max-width:620px){#akwaabaOrb{width:58px;height:58px}#akwaabaOrb svg{width:28px;height:28px}#akwaabaPanel{width:calc(100vw - 18px);max-height:78vh;border-radius:18px;padding:11px}.akwaaba-langs{gap:5px}.akwaaba-lang{font-size:10px;padding:5px}.akwaaba-output{font-size:15px}.akwaaba-block{padding:9px 10px}.akwaaba-image-box img{height:92px}.akwaaba-image-caption{font-size:9px;margin-top:5px}.akwaaba-actions{position:sticky;bottom:0;background:rgba(255,255,255,.96);backdrop-filter:blur(8px);padding-top:8px;margin-top:10px}}'+
