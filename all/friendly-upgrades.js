...
function installStyles(d){
  ...
  '@media(max-width:700px){.rpe-category-groups{flex-wrap:nowrap;overflow-x:auto;padding-bottom:4px;scrollbar-width:none}.rpe-category-groups::-webkit-scrollbar{display:none}.rpe-category-group-btn{flex:0 0 auto;min-height:36px;padding:7px 11px}.rpe-category-shell{padding:0 32px;margin-top:12px}.category-cards.rpe-category-carousel{gap:10px!important;padding:10px 0 16px!important;scroll-snap-type:x mandatory!important;touch-action:pan-x!important;-webkit-overflow-scrolling:touch!important}.category-cards.rpe-category-carousel .category-card,.category-cards.rpe-category-carousel .category-card:last-child{flex:0 0 calc((100% - 20px)/3)!important;width:calc((100% - 20px)/3)!important;min-width:calc((100% - 20px)/3)!important;max-width:calc((100% - 20px)/3)!important;scroll-snap-align:start!important;scroll-snap-stop:always!important}.category-cards.rpe-category-carousel .category-image{width:min(92px,90%)!important;height:auto!important;aspect-ratio:1/1!important;min-height:0!important;max-height:none!important;margin:0 auto 9px!important}.category-cards.rpe-category-carousel .category-card h3{font-size:12px!important;line-height:1.25!important;min-height:30px!important;display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important;word-break:normal!important;overflow-wrap:anywhere!important}.rpe-category-arrow{top:31px;width:36px;height:36px;font-size:21px}.rpe-category-prev{left:-2px}.rpe-category-next{right:-2px}.rpe-category-subtitle{font-size:12px!important}}'+
  '@media(max-width:400px){.rpe-category-shell{padding:0 28px}.category-cards.rpe-category-carousel{gap:8px!important}.category-cards.rpe-category-carousel .category-card,.category-cards.rpe-category-carousel .category-card:last-child{flex:0 0 calc((100% - 16px)/3)!important;width:calc((100% - 16px)/3)!important;min-width:calc((100% - 16px)/3)!important;max-width:calc((100% - 16px)/3)!important}.category-cards.rpe-category-carousel .category-image{width:min(84px,90%)!important;height:auto!important;aspect-ratio:1/1!important}.category-cards.rpe-category-carousel .category-card h3{font-size:11px!important;line-height:1.22!important;min-height:28px!important}.rpe-category-arrow{width:34px;height:34px;top:29px}}'+
...
function installCategoryCarousel(d){
  ...
  // Responsive carousel sizing: four categories on desktop, three on mobile.
  if(!d.getElementById("rpeCategoryFourStyle")){
    ...
    fourStyle.textContent=
      ...
      '.category-cards.rpe-category-carousel .category-image{width:min(132px,82%)!important;height:auto!important;aspect-ratio:1/1!important;min-height:0!important;max-height:none!important;border-radius:50%!important;background:#fff!important;border:1px solid #edf0ee!important;box-shadow:0 10px 26px rgba(12,54,43,.10)!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;margin:0 auto 12px!important}'+
      '.category-cards.rpe-category-carousel .category-image img,.category-cards.rpeFourCategories.rpe-category-carousel .category-card .category-image img{width:88%!important;height:88%!important;max-width:88%!important;object-fit:contain!important;object-position:center!important;transform:none!important;background:transparent!important;border-radius:0!important}'+
      '.category-cards.rpe-category-carousel .category-card>div:last-child{padding:0!important;display:block!important;width:100%!important}'+
      '.category-cards.rpe-category-carousel .category-card small,.category-cards.rpe-category-carousel .category-card span{display:none!important}'+
      ...
      '@media(max-width:700px){.rpe-category-shell{padding:0 32px!important;margin-top:12px!important}.category-cards.rpe-category-carousel{gap:10px!important;padding:10px 0 16px!important;scroll-snap-type:x mandatory!important;touch-action:pan-x!important;-webkit-overflow-scrolling:touch!important}.category-cards.rpe-category-carousel .category-card,.category-cards.rpe-category-carousel .category-card:last-child{flex:0 0 calc((100% - 20px)/3)!important;width:calc((100% - 20px)/3)!important;min-width:calc((100% - 20px)/3)!important;max-width:calc((100% - 20px)/3)!important;scroll-snap-align:start!important;scroll-snap-stop:always!important}.category-cards.rpe-category-carousel .category-image{width:min(92px,90%)!important;height:auto!important;aspect-ratio:1/1!important;margin:0 auto 9px!important}.category-cards.rpe-category-carousel .category-card h3{font-size:12px!important;line-height:1.25!important;min-height:30px!important;display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important;overflow-wrap:anywhere!important}.rpe-category-arrow{top:31px!important;width:36px!important;height:36px!important;font-size:21px!important}}'+
      '@media(max-width:400px){.rpe-category-shell{padding:0 28px!important}.category-cards.rpe-category-carousel{gap:8px!important}.category-cards.rpe-category-carousel .category-card,.category-cards.rpe-category-carousel .category-card:last-child{flex:0 0 calc((100% - 16px)/3)!important;width:calc((100% - 16px)/3)!important;min-width:calc((100% - 16px)/3)!important;max-width:calc((100% - 16px)/3)!important;scroll-snap-align:start!important;scroll-snap-stop:always!important}.category-cards.rpe-category-carousel .category-image{width:min(84px,90%)!important;height:auto!important;aspect-ratio:1/1!important}.category-cards.rpe-category-carousel .category-card h3{font-size:11px!important;line-height:1.22!important;min-height:28px!important;display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important}.rpe-category-arrow{top:29px!important;width:34px!important;height:34px!important}}';
  ...
  if(section){
    ...
    var oldGroups=section.querySelector(".rpe-category-groups");
  ...
  function rankFor(title){
    ...
    if(/ceiling.*fan|fan.*light|bladeless|cooling|heating/.test(t))return 40;
    if(/solar|street light/.test(t))return 50;
    if(/searchlight|torch/.test(t))return 60;
  ...
  function organize(){
    ...
    list.sort(function(a,b){
      return rankFor(cleanTitle(a))-rankFor(cleanTitle(b))||cleanTitle(a).localeCompare(cleanTitle(b));
    });
  ...
  if(!shell||!shell.classList.contains("rpe-category-shell")){
    ...
    prev.setAttribute("aria-label","Previous product category");
    prev.innerHTML="&#8249;";

    var nextBtn=d.createElement("button");
    nextBtn.type="button";
    nextBtn.className="rpe-category-arrow rpe-category-next";
    nextBtn.setAttribute("aria-label","Next product category");
    nextBtn.innerHTML="&#8250;";
    ...
    function step(){
      ...
      if(!first)return 160;
      var gap=parseFloat(getComputedStyle(cards).gap)||0;
    ...
    // Each click shifts by exactly one category.
    prev.onclick=function(){cards.scrollBy({left:-step(),behavior:"smooth"})};
    nextBtn.onclick=function(){cards.scrollBy({left:step(),behavior:"smooth"})};
    ...
    cards.addEventListener("keydown",function(e){
      if(e.key==="ArrowRight"){e.preventDefault();cards.scrollBy({left:step(),behavior:"smooth"})}
      if(e.key==="ArrowLeft"){e.preventDefault();cards.scrollBy({left:-step(),behavior:"smooth"})}
    });
  ...
  if(!cards.__rpeCategoryObserver){
    var observer=new MutationObserver(function(mutations){
      ...
      setTimeout(function(){
        ...
        if(cards.__rpeUpdateArrows)cards.__rpeUpdateArrows();
      },0);
    });
    observer.observe(cards,{childList:true,subtree:false});
    cards.__rpeCategoryObserver=observer;
  }

  cards.scrollLeft=0;
  if(cards.__rpeUpdateArrows)setTimeout(cards.__rpeUpdateArrows,50);
  return true;
}
