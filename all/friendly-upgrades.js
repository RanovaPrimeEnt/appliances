...
function installStyles(d){
  ...
  '@media(prefers-reduced-motion:reduce){html:focus-within{scroll-behavior:auto!important}.rpe-compare-bar,.rpe-backtop,.rpe-skip-link,.rpe-search-option{transition:none!important}}';
